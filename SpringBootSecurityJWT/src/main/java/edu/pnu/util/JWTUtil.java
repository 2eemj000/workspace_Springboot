...
public class JWTUtil {
	private static final long ACCESS_TOKEN_MESC = 100*(60*1000); // 100분
	private static final String JWT_KEY = "edu.pnu.jwtkey"; // 인코딩을 위한 secret_key
	...
	public static String getJWT(String username, long ACCESS_TOKEN_MSEC) {
